    ...
    <li class="nav-item dropdown">
        ...
        <div class="page-wrapper">
            ...
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="https://www.youtube.com/@codecampbdofficial"><a href="https://www.youtube.com/@codecampbdofficial"></a></marquee>
            </div>
